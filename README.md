...
**IT Support Technician | Network Support | Lagos, Nigeria**
...
- Provision and repair Windows PCs (OS, apps, hardware upgrades)
- Keep small-office networks online (routers, APs, DHCP reservations, basic switching)
- Own domains, DNS records and staff email / hosting renewals
- Install and maintain CCTV (NVR, PoE, viewing clients)
- Escalate ISP and vendor faults and stay on the ticket until service returns

## What I build in the lab
